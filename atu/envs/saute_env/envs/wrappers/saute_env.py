...
from atu.envs.saute_env.envs.utils import Array
...
def saute_env(cls):
    ...
    class SauteEnv(Env):
        def __init__(
            ...
            max_ep_len: int = 200,
            min_rel_budget: float = 1.0,  # minimum relative (with respect to safety_budget) budget
            max_rel_budget: float = 1.0,  # maximum relative (with respect to safety_budget) budget
            test_rel_budget: float = 1.0,  # test relative budget
